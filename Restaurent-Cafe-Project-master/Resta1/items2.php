    ...
    <div class="header">
        <div class="container">
            <div class="top-header">
                <div class="logo">
                <a href="index.php"><Strong><h3><b><i>YOUR's</i></b> ----- The Food Rush --->(ITEMS) </h3></strong></a>
            </div>
            <!--<div class="queries">
                ...
                <?php
                   ...
                   while($row1 = mysqli_fetch_assoc($result1))
                   {
                    ...
                    while($row = mysqli_fetch_assoc($result)) 
                    {
                            ...
                            echo "<img src='uploads/". $row['item_image'] . "'". " class='img-responsive' alt='Image' />";
                            ...
                            echo     '<h4><a href="#">' .$row["item_name"] .'</a></h4>';

                            echo     '</div>';

                            echo    '<div class="logo-title logo-title-5">';

                            echo     '<h4><a href="#">'.'&#x20B9;'. $row["price"]. '</a></h4>';

                            echo    '</div>'; 

                            /*echo  '<div class="logo-title logo-title-5">';

                            echo     '<h4><a href="#">'. $row["description"]. '</a></h4>';
                            ...
                            echo    '<a class="morebtn hvr-rectangle-in" href="popular-Restaurents.php">Grab it</a>';
