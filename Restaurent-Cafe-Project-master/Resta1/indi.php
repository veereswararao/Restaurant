   ...
   <li><span><div class="banner wow fadeInUp" data-wow-delay="0.4s" id="Home"></span>
        <div class="container">
            <div class="banner-info">
                <div class="banner-info-head text-center wow fadeInLeft" data-wow-delay="0.5s"><br/><br/><br/><br/><br/>
        ...
        <div class="container">
            <div class="banner-info">
                <div class="banner-info-head text-center wow fadeInLeft" data-wow-delay="0.5s">
                    <h1><strong><i>YOUR's</i></strong> Restaur & Cafe</h1>
                    <div class="line">
                        <h2> We've &nbsp;Choosen  &nbsp;Best  &nbsp;Infra  &nbsp;Restaurants  &nbsp;for  &nbsp;You</h2>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="banner-info">
                <div class="banner-info-head text-center wow fadeInLeft" data-wow-delay="0.5s">
                    <h1><strong><i>YOUR's</i></strong> Restaur & Cafe</h1>
                    <div class="line">
                        <h2> A  &nbsp;Pleasant &nbsp;and &nbsp;Lovely &nbsp;Service</h2>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="banner-info">
                <div class="banner-info-head text-center wow fadeInLeft" data-wow-delay="0.5s">
                    ...
                    <h1><strong><i>YOUR's</i></strong> Restaur & Cafe</h1>
                    <div class="line">
                        <h2> Make &nbsp;a &nbsp;Fine &nbsp;Dine &nbsp;with &nbsp;Loved &nbsp;Ones</h2>
                    </div>
                </div>
			...
			<div class="service-section-top-row">
				<div class="container">
					...
					<div class="col-md-2 service-section-top-row-grid4 wow swing animated" data-wow-delay= "0.4s">
						<a href="#"><input type="submit" value="Order Now"></a>
					</div>
					<div class="clearfix"></div>
					</div>
				</div>
